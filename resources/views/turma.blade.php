                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <table class="table table-hover caption-top">
                                <caption> <h2 style="font-family: 'Courier New', Courier, monospace; font-size: x-large; color: black;">SIIP-Turmas
                                <nav class="navbar bg-body-tertiary">
                                    <div class="container-fluid">
                                        <form class="d-flex" role="search" action="{{route('consulta.turma')}}" method="GET">
                                            @csrf
                                        
                                        <input class="form-control me-2" type="search" name="search"  placeholder="Campo  de pesquisa" aria-label="Search" required>
      ...
      <div class="modal-body">
             ...
             <form action="{{ route('turma.destroy',$turma->id) }}"  method="DELETE" class="row g-3" style="background-color: black;">
                @csrf
                    ...
                    <h3 style="color: red;">Deseja Ilimimar {{$turma->nome}} ?</h3>
